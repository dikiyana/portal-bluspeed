...
![UI Preview](portal_bluspeed_ui.png)


## 🚀 Portal BLU Speed

**Portal BLU Speed** is a landing page that consolidates project and event information for easy access and management.

It is inspired by [Landy]—an open-source React landing page template built with TypeScript. Landy is designed for developers and startups who want to quickly create a professional landing page for their business or project.

This template features multi-language support, smooth animations, and a collection of ready-to-use sections. Most importantly, all content is managed through JSON files, allowing you to update text without needing any prior knowledge of React.js.
...
Check the live demo here 👉️ https:bluspeed.id
